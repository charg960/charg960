# Hi, I'm Charlotte Dickson!

I’m a Math & Computer Science double major at Maryville College with minors in Data Analysis, Statistics, and Analytics.  

🚀 **Where My Passions Intersect:** I used to think my interests in astrophysics and computer science were competing goals, but now I know they're entirely complementary. I see computer science as a necessary skill to explore complex physical systems, and I'm deeply passionate about mathematical modeling, fluid/astrophysical dynamics, and scientific computing.

👩🏻‍💻 **How I Build:** I use computational, data-driven approaches to analyze complex, particularly noisy systems. I thrive on tackling problems that span multiple disciplines, and I really enjoy learning from experts and contributing to team solutions through collaboration. Outside research, I build simulations and applications that combine back-end database design with front-end interfaces for accessible scientific exploration.

---

- **Pronouns:** She/Her 🤍
- **Fun fact:** You will rarely catch me coding without headphones and a coffee nearby 🎧☕️
- **I'm currently exploring:** Machine learning pipelines, dynamical systems (particularly fluid and plasma energy dynamics), and stochastic calculus applied to computer simulation, with the end goal of better understanding aerospace and astrophysical systems. My skills have also led me into biological modeling, where I'm actively collaborating on a UMN project on soft matter and bacteriophage dynamics. My independent Bayesian/ML project on incarceration policy is currently paused.
- **Let's talk:** I'd love to collaborate on mathematical and computational modeling of physical systems, nonlinear dynamical systems, computational biology, and open-source scientific computing tools. I'm looking for guidance in HPC, uncertainty quantification, surrogate modeling, and numerical methods for differential equations. Ask me about energy minimization, fluid/cellular dynamics, bridging CS and astrophysics, or my current work on bacteriophage lifecycle modeling and Bayesian/ML methods (MCMC, SHAP) for policy analysis.
