...
- **Ask me about:** Mathematical modeling, integrating data systems with front-end interfaces, and bridging the gap between computer science and astrophysics. You can also ask me about my current work with MCMC inference and utilizing SHAP values for algorithmic explainability, or my collaboartive Research Project on mathematically modeling bacteriophage lifecycles and infection processes! 
- **Pronouns:** She/Her 🤍
